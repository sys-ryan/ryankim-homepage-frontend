...
const PostItem = (props: { title: string; thumbnail: string; excerpt: string }) => {
  return (
    <div className="shadow-xl mb-8 flex flex-col mt-[2rem] lg:w-[50rem] lg:h-[40rem] lg:mx-auto">
      ...
      <Image
        ...
        priority
      />
      <div className="mt-5 mb-10 px-4 text-md lg:text-xl lg:px-8 break-normal">{props.excerpt}</div>
    </div>
  );
};
